...
//!
//! Parses codexpro:// URLs into DeepLinkImportRequest structures.
...
/// Parse a codexpro:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// codexpro://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "codexpro" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'codexpro', got '{scheme}'"
        )));
    }
